...
import JTG from '../assets/fonts/JTG_.woff2'
import Chirp from '../assets/fonts/Chirp.woff2'
import ChirpBold from '../assets/fonts/ChirpBold.woff2'
...
export const GlobalStyle = createGlobalStyle`
  * {
  ...
  @font-face {
    font-family: "HelveticaNeue";
    src: url(${ChirpBold}) format('woff2');
    font-weight: 700;
    font-style: normal;
    font-display: swap;
  }
